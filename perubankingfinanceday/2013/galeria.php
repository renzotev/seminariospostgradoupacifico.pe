...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Seminarios Escuela de Postgrado - Peru Banking & Finance Day 2013 - Galería de fotos</title>
        ...
        <div class="main">
            ...
            <div class="content">
                <div class="inner-banner">
                    <figure>
                        <img src="/img/perubankingfinanceday/2013/banners/galeria-banner.png">
                    </figure>
                </div>
                <?php
                        ...
                        <div class="presentations">
                            <div id="sliderFrame">
                                <div id="slider">
                                    ...
                                    ?>
                                        <a class="fancybox" href="/img/perubankingfinanceday/2013/galeria/large/<?php echo $i; ?>.png" data-fancybox-group="gallery">
                                            <img src="/img/perubankingfinanceday/2013/galeria/large/<?php echo $i; ?>.png" alt="Perú Banking & Finance Day - 2013" />
                                        </a>
                                    <?php
                                        }
                                    ?>
                                ...
                                <div id="thumbs">
                                    ...
                                    ?>
                                    <div class="thumb">
                                        <div class="frame"><img src="/img/perubankingfinanceday/2013/galeria/thumb/<?php echo $i; ?>sm.png" /></div>
                                        <div class="thumb-content"><p>Perú Banking & Finance Day - 2013</p></div>
