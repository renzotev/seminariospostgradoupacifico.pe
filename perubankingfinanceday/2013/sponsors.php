...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Seminarios Escuela de Postgrado - Peru Banking & Finance Day 2013 - Sponsors</title>
        ...
        <div class="main">
            ...
            <div class="content">
                <div class="inner-banner">
                    <figure>
                        <img src="/img/perubankingfinanceday/2013/banners/sponsors-banner.jpg">
                    </figure>
                </div>
                <?php
                ...
                <div class="main-content-wrapper">
                    <div class="expositores">
                        ...
                        <img src="/img/perubankingfinanceday/2013/sponsors.jpg" style="width:100%" alt="">
                    </div>
                </div>
                <?php
