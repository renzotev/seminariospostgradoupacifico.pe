...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Seminarios Escuela de Postgrado - Peru Banking & Finance Day 2012 - Prensa</title>
        ...
        <div class="main">
            ...
            <div class="content">
                <div class="inner-banner">
                    <figure>
                        <img src="/img/perubankingfinanceday/2012/banners/prensa-banner.png">
                    </figure>
                </div>
                <?php
                ...
                <div class="main-content-wrapper">
                    <div class="expositores">
                        ...
                        <img src="/img/provicional/prensa-banking2012.png" style="width:100%" alt="">
                    </div>
                </div>
                <?php
