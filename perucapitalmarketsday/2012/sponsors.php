...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Seminarios Escuela de Postgrado - Peru Capital Markets Day 2012 - Sponsors</title>
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="content">
                <div class="inner-banner">
                    <figure>
                        <img src="/img/perucapitalmarketsday/2012/banners/sponsors-banner.png">
                    </figure>
                </div>
                <?php
                ...
                <div class="main-content-wrapper">
                    <div class="expositores">
                        ...
                        <img src="/img/perucapitalmarketsday/2012/sponsors.png" alt="" style="width:100%">
                    </div>
                </div>
                <?php
        ...
        <script>
            $(".secondary-menu ul").children("li").eq(3).addClass("active");
        </script>
    </body>
</html>
