...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Seminarios Escuela de Postgrado - Peru Capital Markets Day 2012 - Contáctenos</title>
    ...
    <body>
        ...
        <div class="main">
            ...
            <div class="content">
                <div class="inner-banner">
                    <figure>
                        <img src="/img/perucapitalmarketsday/2012/banners/contactenos-banner.png">
                    </figure>
                </div>
                <?php
                ...
                <div class="main-content-wrapper">
                    <div class="expositores">
                        ...
                        <img src="/img/contactenos-markets.png" style="width:100%" alt="">
                    </div>
                </div>
                <?php
        ...
        <script>
            $(".secondary-menu ul").children("li").eq(9).addClass("active");
        </script>
    </body>
</html>
